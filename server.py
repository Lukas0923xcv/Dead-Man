  ...
  <script>
    const I18N = {
      ...
      en: {
        ...
        step1_desc: "Type text or attach confidential documents.",
        step2_title: "Split-Key Split",
        step2_desc: "Generated into 256-bit Key A and Key B.",
        step3_title: "Zero-Knowledge",
        ...
        feat5_desc: "Files, text, and filenames are encrypted before storage. Server infrastructure providers cannot read or inspect your secrets.",
        ...
        enc_title: "Encrypt Data & Files",
        enc_subtitle: "Encrypted with a dual-key split. The server cannot read files or text.",
        enc_label_text: "Secret Notes / Information",
        enc_hint_text: "(Optional if attaching a file)",
        enc_ph_text: "Type confidential notes, credentials, or instructions...",
        ...
        dec_hint_key_b: "(Only needed on other devices or in Inherited Mode)",
